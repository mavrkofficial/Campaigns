...
contract TokenCampaign is ReentrancyGuard {
    ...
    /// @notice Uniswap V3 Position Manager address (Base Network)
    address public constant POSITION_MANAGER = 0x03a520b32C04BF3bEEf7BEb72E919cf822Ed34f1;
    
    /// @notice Wrapped ETH address (Base Network)
    ...
    /// @notice LP locker contract address for permanent locking (Base Network)
    address public constant LOCKER = 0x1695bF3C4D960d2A63548854846407B20BE07f08;
    ...
    function launchToken() external nonReentrant {
        ...
        address SWAP_ROUTER = 0x2626664c2603336E57B271c5C0b26F421741e481; // Base Network SwapRouter02
...
contract CampaignFactory {
    ...
    {
        TokenCampaign campaign = new TokenCampaign(msg.sender, _name, _symbol);
        deployedCampaigns.push(address(campaign));
        emit NewCampaignDeployed(msg.sender, address(campaign), _name, _symbol);
